Primary [encoding probes](MOLECULAR_MARKER) generation was performed from [oligonucleotide pools](MOLECULAR_MARKER) as described previously [42][43][44]. [Oligonucleotide pools](MOLECULAR_MARKER) and primers were purchased from Twist Biosciences and Integrated DNA Technologies (IDT), respectively. Oligo pools were amplified through PCR with approximately 18 cycles using Phusion Plus PCR Master Mix (Thermo Fisher Scientific, F631L). The resulting PCR product was purified and concentrated with Zymo DNA clean & concentrator-25 (Zymo Research, D4006). RNA was generated from the purified PCR-amplified DNA through in-vitro transcription (IVT) using HiScribe T7 ARCA mRNA kit (NEB, E2060S).
...
[Adaptor probes](MOLECULAR_MARKER) (total 28 [adaptors](MOLECULAR_MARKER)) and [readout probes](MOLECULAR_MARKER) (total 3 [readout probes](MOLECULAR_MARKER) each tagged with one of the three fluorophores:
...
Analysis of gene expression gradients in the [striatum](BRAIN_REGION) using stereo-seq data
